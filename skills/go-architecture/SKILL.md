...
description: Architectural guidelines for Go projects following Domain-Driven Design (DDD) and Clean Architecture principles. Focuses on layer boundaries, dependency rules, and rich domain models.
license: APACHE-2.0
metadata:
  author: Direkt, Inc.
  version: "1.0.0"
